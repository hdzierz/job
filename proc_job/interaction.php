...
?>	
	<input class="coural_button" type="button" name="PMPPI" value="Print PMP PI" onClick="window.location.href='proc_job.php?pub=<?=$pub?>&client=<?=$client?>&action=print_pmp_pi&job_id=<?=$job_id?>'" />

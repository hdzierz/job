...
?>
	<script type="text/javascript" src="includes/calendarDateInput.js"></script> 
	<form name="addresstype" action="rep_revenue.php" method="get">
		<table>
			<tr>
				<td colspan="3"></td>
				<th>Include</th>
...
if($report=="rep_cirpay_by_payee_subsum"){
	$today=date("Y-m-d");
?>
	<form name="rep_cirpay_by_payee_subsum" action="rep_revenue.php" method="get">
		<table>
			<tr>
				<td>
					Month:
...
if($report=="rep_cirpay_by_payee"){
	$today=date("Y-m-d");
?>
	<form name="rep_cirpay_by_payee" action="rep_revenue.php" method="get">
		<table>
			<tr>
				<td>
					Month:
